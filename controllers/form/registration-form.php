                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <!-- http://<?php echo $rws['domain_websiteaddress'];?>/user_username= --> affinity.com/
                                    </span>
                        ...
                        <div class="row">    
                            <div class="col-lg-6">
                                <div class="form-group" style="text-align:center">
                                    <button class="btn btn-default ladda-button"  data-style="zoom-in" type="submit"  id="SubmitButton" value="Upload" style="margin-left:120px;font-size:20px;" name="signup_button"/>Register</button>
                                </div>
                            </div>
                        </div>
                    </form>