        ...
        <div class="form-group float-label-control">
            <a href="http://<?php echo $rws['domain_websiteaddress'];?>/<?php echo $rws['user_username'];?>">        
                <div class="input-group">
                    <span class="input-group-addon">http://<?php echo $rws['domain_websiteaddress'];?>affinity.me/</span>
                    <fieldset disabled> 
...
?>     
    ...
    <div class="submit" style="margin-top:20px;">           
        <center>
            <button class="btn btn-primary ladda-button" data-style="zoom-in" type="submit"  id="SubmitButton" value="Upload" style="margin-top: 20px;
    font-size: 20px;
    border-radius: 0;"/>Save Your Profile</button>
        </center>
    </div>
</form>